...
const minLength = function(numero,error) {
...
const maxLength = function(numero,error) {
	return new Validator(numero,error,function(string,numero,error){
...
const min = function(number,error){
...
const greater = function(number,error){
...
const less = function(number,error){
	return new Validator(number,error,function(n1,n2,error){
		if(typeof n1 == "number"){
			if(n1 >= n2){
				return {error:error,type:NOPASS};
...
const max = function(number,error){
...
module.exports = {Validator,minLength,maxLength,NOPASS,NOES,email,phone,date,min,max,greater,less,url};